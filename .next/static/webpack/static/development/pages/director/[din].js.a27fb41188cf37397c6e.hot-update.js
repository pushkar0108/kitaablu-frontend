...
var Home = function Home(_ref) {
  ...
  return __jsx(_src_Components__WEBPACK_IMPORTED_MODULE_7__["Layout"], null, __jsx("h1", {
    ...
    scope: "col",
    className: "border-0"
  }, "Status"))), __jsx("tbody", null, dinData.llps.length ? dinData.llps.map(function (llp, index) {
    return __jsx("tr", {
  ...
  }) : __jsx("tr", null, "No LLP mapped to the director"))))));
};
...
//# sourceMappingURL=[din].js.a27fb41188cf37397c6e.hot-update.js.map
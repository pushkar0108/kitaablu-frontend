...
var Home = function Home(_ref) {
  ...
  return __jsx(_src_Components__WEBPACK_IMPORTED_MODULE_7__["Layout"], null, __jsx(next_seo__WEBPACK_IMPORTED_MODULE_3__["NextSeo"], {
    ...
    className: "card-body"
  }, __jsx("div", null, companyName, " is a ", details["Class of Company"], " incorporated on ", details["Date of Incorporation"], ". It is classified as ", details["Company SubCategory"], " and is registered at Registrar of Companies, ", details["ROC Code"], "."), __jsx("div", null, "Its authorized share capital is INR ", details["Authorised Capital(Rs)"], " and its paid up capital is INR ", details["Paid up Capital(Rs)"], ". It's a ", details["Whether Listed or not"], " company."), __jsx("div", null, companyName, " is a ", details["Class of Company"], " incorporated on ", details["Date of Incorporation"], ". It is classified as ", details["Company SubCategory"], " and is registered at Registrar of Companies, ", details["ROC Code"], "."), "Directors of ", companyName, " are ", companyName, companyName, "'s Corporate Identification Number is (CIN)", 'CIN', " and its registration number is 110341.Its Email address is ", 'emailId', " and its registered address is ", 'address', "Current status of Gocessor Private Limited is - ", 'Active/Unactive', ".")), __jsx("div", {
    className: "card mb-4"
  }, __jsx("div", {
    className: "card-body"
  }, __jsx("div", {
...
//# sourceMappingURL=[cin].js.2f8b1c17b24966957907.hot-update.js.map
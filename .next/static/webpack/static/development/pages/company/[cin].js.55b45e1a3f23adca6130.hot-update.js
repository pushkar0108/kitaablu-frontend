...
var Home = function Home(_ref) {
  ...
  return __jsx(_src_Components__WEBPACK_IMPORTED_MODULE_7__["Layout"], {
    ...
    id: "location"
  }, "Location on Maps"), __jsx("div", {
    className: "card mb-4 shadow bg-white rounded"
  }, __jsx("div", {
    className: "card-body"
  }, details["Registered Address"].length > 0 && __jsx("iframe", {
    className: "embed-responsive-item",
    style: {
      width: '100%'
    },
    frameBorder: "0",
    src: "https://www.google.com/maps/embed/v1/place?q=".concat(details["Registered Address"].replace(/ /g, '+'), "&key=AIzaSyCrpmMagfAnUiDnQwj4PTXjb7-FmPQ6Jxo")
  }))), __jsx("h4", {
    id: "similarCompanies"
...
//# sourceMappingURL=[cin].js.55b45e1a3f23adca6130.hot-update.js.map
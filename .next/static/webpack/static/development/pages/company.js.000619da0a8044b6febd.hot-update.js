...
var Home = function Home(_ref) {
  ...
  return __jsx(_src_Components__WEBPACK_IMPORTED_MODULE_5__["Layout"], null, __jsx("h1", {
    className: "my-4"
  }, __jsx("small", null)), __jsx("div", {
    className: "card mb-4"
  }, __jsx("h2", {
    className: "card-header"
  }, "List of companies registered in last 3 days"), __jsx("div", {
    className: "card-body"
  ...
  })))) : __jsx("div", null, "No Company registered"))), __jsx("div", {
    className: "card mb-4"
  }, __jsx("div", {
    className: "card-body"
  }, __jsx("table", {
    ...
    scope: "col"
  }, "CIN"))), __jsx("tbody", null, companies.map(function (company) {
    return __jsx("tr", {
      key: "company_".concat(company.CIN),
      className: "text-semibold text-reagent-gray"
    }, __jsx("td", null, __jsx(next_link__WEBPACK_IMPORTED_MODULE_2___default.a, {
      href: "/company/[cin]",
      as: "/company/".concat(company.CIN)
    }, __jsx("a", null, company.CIN))));
  }))))));
};
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _context.next = 7;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(_src_Services_API_Http__WEBPACK_IMPORTED_MODULE_6__["Http"].Request('GET', "https://kitaablu.com/api/v1/company?doiDayDiff=3"));
...
//# sourceMappingURL=company.js.000619da0a8044b6febd.hot-update.js.map